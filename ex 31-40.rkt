...
(define roof-width (/ body-width 2))
(define roof-height (/ body-height 2))

(define body (rectangle body-width body-height "solid" "red"))
(define roof (rectangle roof-width roof-height "solid" "red"))

(define car-top (above roof body))

(define Wheel-radius 15)
(define Wheel (circle Wheel-radius "solid" "black"))
(define Wheel-space (rectangle roof-width Wheel-radius "solid" "white"))

(define car-bottom (beside Wheel Wheel-space Wheel))

(define vehicle (above car-top car-bottom))
